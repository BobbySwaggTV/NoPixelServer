...
AddEventHandler("character:loadspawns", function()
    ...
    exports.ghmattimysql:execute("SELECT cid, roomType FROM __housing where cid = @cid ", {['cid'] = cid}, function(housingMotels)
        exports.ghmattimysql:execute("SELECT house_id FROM __housedata where cid = @cid", {['cid'] =  cid}, function(housing_keys)
            if housingMotels[1] then
                ...
                exports.ghmattimysql:execute("INSERT INTO __housing (cid, roomType) VALUES (@cid, @roomType)", {['cid'] = cid, ['roomType'] = '1'})
